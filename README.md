...
| window (6) | 0.067 | 0.060 | 1.000 | 0.000 | 71 | 70 / 74 |
| vector (k=3) | 0.956 | 0.706 | 0.923 | 0.992 | **23** | 26 / 28 |
| summary | 0.485 | 0.473 | 0.654 | 0.365 | 56 | 86 / 141 |
| hybrid | **0.958** | **0.723** | **1.000** | 0.965 | 89 | 83 / 96 |

(The N columns are "fact in context" by distance.)

- **The window is perfect inside its horizon and useless beyond it.** It recalls 1.000 for N≤5, 0.147 at N=6–10, and 0.000 after that.
...
- **Rolling summaries forget gradually.** Recall drops from about 0.65 to 0.365 for the oldest facts, as re-compression evicts lines under the 60-word budget. The IDF salience heuristic cannot tell a rare fact from a rare piece of small talk.
